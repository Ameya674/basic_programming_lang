...
class Position: 
    ...
    def copy(self):
        return Position(self.idx, self.ln, self.col, self.fn, self.fntxt)
    ...
    def make_tokens(self) -> list:
        ...
        while self.current_char != None:
            if self.current_char in ' \t':
                ...
                tokens.append(Token(LPARENTHESIS))
                self.advance()
            elif self.current_char == ')':
                tokens.append(Token(RPARENTHESIS))
                self.advance()
            else:
